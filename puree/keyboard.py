...
class KeyManager:
    ...
    def bind(
        self, key_combo: str, callback: Callable, when: Optional[str] = None, container_id: Optional[str] = None
    ) -> KeyBinding:
    ...
    def dispatch(self, event, focused_container_id: Optional[str] = None, any_input_focused: bool = False) -> bool:
        """
