    ...
    def print_ui_struct(self):
        def find_children(children):
            for child in children:
                ...
                print(f" ├─  BG Color           : {child.background_color}")
                print(f" ├─  BG Color2          : {child.background_color_2}")
                print(f" ├─  BG Gradient Rot    : {child.background_gradient_rot}")
                print(f" ├─  Hover BG Color     : {child.hover_background_color}")
                print(f" ├─  Hover BG Color2    : {child.hover_background_color_2}")
                print(f" ├─  Hover BG G Rot     : {child.hover_background_gradient_rot}")
                print(f" ├─  Click BG Color     : {child.click_background_color}")
                print(f" ├─  Click BG Color2    : {child.click_background_color_2}")
                print(f" ├─  Click BG G Rot     : {child.click_background_gradient_rot}")
                print(f" ├─  Border Radius      : {child.border_radius}")
                print(f" ├─  Border Width       : {child.border_width}")
                print(f" ├─  Border Color       : {child.border_color}")
                print(f" ├─  Border Color2      : {child.border_color_2}")
                print(f" ├─  Border Gradient Rot: {child.border_gradient_rot}")
                print(' ├───────────────────────────────────────────')
                ...
                print(f" ├─  Font Size        : {child.font_size}")
