...
user-invocable: true
argument-hint: 'Describe what to build (e.g. "settings panel with dark theme", "render queue dashboard")'
---
...
2. **Check docs/.impeccable.md (fast)**: If not in instructions, read `docs/.impeccable.md` from the project root. If it exists and contains the required context, proceed.
...
- Correct for Puree (use only supported properties — see Puree documentation PUREE_VS_CSS.md)
