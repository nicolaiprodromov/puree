...
impl SCSSCompiler {
    ...
    pub fn compile(
        ...
        let compiled_css =
            grass::from_string(final_scss, &grass::Options::default()).map_err(|e| {
    ...
    pub fn compile_file(
        ...
        let scss_content = std::fs::read_to_string(&filepath).map_err(|e| {
            PyErr::new::<pyo3::exceptions::PyIOError, _>(format!(
                "Failed to read SCSS file {}: {}",
                filepath, e
            ))
        })?;
                ...
                for selector in selectors {
                    ...
                    if !selector.is_empty() {
                        ...
                        let namespaced = if base == component_base_name {
                            ...
                            format!(
                                "{}{}",
                                base.replacen(component_base_name, namespace, 1),
                                pseudo_suffix
                            )
